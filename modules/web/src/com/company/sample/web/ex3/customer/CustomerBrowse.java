...
public class CustomerBrowse extends AbstractLookup {
    ...
    public void onCalcDiscount(Component source) {
        ...
        BigDecimal discount = discountService.calculateDiscount(selectedCustomer.getId());
    ...
    public void init(Map<String, Object> params) {
        customersTableCreate.setWindowId("sample$Customer.edit_3");
        customersTableEdit.setWindowId("sample$Customer.edit_3");
    }
}